...
class Toolbox extends React.Component<Props, State>{
    ...
    addVariables() {
        return <div className="group" id="variables">
            <p>Variables</p>
    ...
    buildToolbox() {
        return <div id="mainToolboxDiv" className={this.props.className}>
            {options.functionCalls ? this.addFunctionCalls() : null}
            {options.controlFlow ? this.addControlFlow() : null}
            ...
            {options.operations ? this.addOperations() : null}
            {options.booleans ? this.addBooleans() : null}
            {options.comparisons ? this.addComparisons() : null}
        </div>
    }
