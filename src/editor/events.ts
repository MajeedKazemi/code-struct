...
export class EventHandler {
    ...
    onButtonDown(id: string) {
        switch (id) {
            ...
            case "add-str-btn":
                this.module.insert(new AST.LiteralValExpr('"txt"', AST.DataType.String));
                break;

            case "add-num-btn":
                this.module.insert(new AST.LiteralValExpr("123", AST.DataType.Number));
                break;

            case "add-true-btn":
                this.module.insert(new AST.LiteralValExpr("True", AST.DataType.Boolean));
                break;

            case "add-false-btn":
                this.module.insert(new AST.LiteralValExpr("False", AST.DataType.Boolean));
                break;
